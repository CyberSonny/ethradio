/************************************************************
*
Driver for ENC28j60 and ATMEL AVR MCU
patched by Alexander Yerezeyev
wapbox@bk.ru
*
************************************************************/
#ifndef ENC28J60_H
...
#define ENC28J60_SS_PIN		2
#define ENC28J60_RST_PIN    	1
//
...
#define TXSTART_INIT   	0x1FFF- ETH_MAX_PACKET_SIZE-64//0x1EF4  // start TX buffer (8191-7152)=1039 байт
                                //It is recommended that an even address 
                                // be used for ETXST
#define RXSTART_INIT   	0x0000	// It is recommended that the ERXST
                                //Pointer be programmed with an even address.
#define RXSTOP_INIT    	TXSTART_INIT-2//0x1EF1  // only odd values! see errata
#define	MAX_FRAMELEN	ETH_MAX_PACKET_SIZE+4	// maximum ethernet frame length
...
extern u8 Enc28j60Bank;

#define ENC28J60_RESET() \
  cbi (ENC28J60_CONTROL_PORT, ENC28J60_RST_PIN);\
  _delay_us(100);\
  sbi (ENC28J60_CONTROL_PORT, ENC28J60_RST_PIN);
